...
// Bonus: a from-scratch HashMap implementation (chaining)
public class CustomHashMap<K, V> {
    ...
    public CustomHashMap() { buckets = new CustomHashMap.Node[DEFAULT_CAPACITY]; }
    ...
    private void resize() {
        Node[] old = buckets;
        buckets = new CustomHashMap.Node[old.length * 2];
        size = 0;
        for (Node head : old) {
            Node cur = head;
    ...
    public static void main(String[] args) {
        ...
        CustomHashMap<Integer, Integer> bigMap = new CustomHashMap<>();
