...
public class Array2DProblems {
    ...
    public static void main(String[] args) {
        ...
        // Diagonal sum
        System.out.println("Diagonal sum: " + diagonalSum(matrix));  // 25
        ...
        rotate90(m2);
        System.out.println("Rotated: " + Arrays.deepToString(m2));  // [[7,4,1],[8,5,2],[9,6,3]]

        // Transpose
        int[][] m3 = {{1,2,3},{4,5,6},{7,8,9}};
        transpose(m3);
        System.out.println("Transposed: " + Arrays.deepToString(m3));  // [[1,4,7],[2,5,8],[3,6,9]]

        // Search
        System.out.println("Found 5: " + searchMatrix(matrix, 5));  // true
